# Release v1.0-physica-a-submission

This release fixes the reproducibility materials used for the initial
special-issue submission.

## Included in the repository

- active simulation code;
- quick and full execution commands;
